...
function Quiz() {
  return (
    <div className="uk-cover-container uk-height-viewport" id="quizContainer">
      <h1 className="uk-heading-medium uk-text-center" id="header"><span>Who would win at 1 on 1?</span></h1>
      ...
      <div className="uk-flex uk-flex-center" id="centerQuiz">
        <div className="uk-card uk-card-hover uk-width-1-3@m">
          ...
          <div className="uk-card-footer">
            <h3>Michael Jordan AKA the GOAT</h3>
          </div>
        </div>
        <div className="PvP">
        ...
        <div className="uk-card uk-card-hover uk-width-1-3@m">
          ...
          <div className="uk-card-footer">
            <h3>LeBron James AKA King James</h3>
          </div>
        </div>
      </div>
    </div>
